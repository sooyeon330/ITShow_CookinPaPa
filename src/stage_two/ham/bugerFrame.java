...
import AdditionalFunction.Timer_buger;

public class bugerFrame extends JPanel{
	static ImageIcon keyimg[] = { new ImageIcon(bugerFrame.class.getClassLoader().getResource("pic/key1.png")), // left
			new ImageIcon(bugerFrame.class.getClassLoader().getResource("pic/key2.png")), // up
			new ImageIcon(bugerFrame.class.getClassLoader().getResource("pic/key3.png")), //right
			new ImageIcon(bugerFrame.class.getClassLoader().getResource("pic/key4.png"))}; //down

	static ImageIcon presskeyimg[] = { new ImageIcon(bugerFrame.class.getClassLoader().getResource("pic/presskey1.png")), // left
				new ImageIcon(bugerFrame.class.getClassLoader().getResource("pic/presskey2.png")), // up
				new ImageIcon(bugerFrame.class.getClassLoader().getResource("pic/presskey3.png")), //right
				new ImageIcon(bugerFrame.class.getClassLoader().getResource("pic/presskey4.png"))}; //down
	//
	static ImageIcon basebugimg = new ImageIcon(bugerFrame.class.getClassLoader().getResource("pic/hamburger1.png"));
	
	static ImageIcon successimg = new ImageIcon(bugerFrame.class.getClassLoader().getResource("pic/success.png"));
	static ImageIcon failimg = new ImageIcon(bugerFrame.class.getClassLoader().getResource("pic/fail.png"));
	...
	public bugerFrame(JFrame frame) {
		this.setLayout(new GridLayout(1,2));
		JPanel panel1 = new bugerTestpanel(frame);
		JPanel panel2 = new bugerTestpanel2(frame);
...
//		Timer timer = new Timer(10, this, frame,1);
		...
		Timer_buger timer = new Timer_buger(30,this, panel1, panel2, frame,1);
		timer.start();
...
//			System.out.println("2p : "+p);
	...
	public synchronized static ImageIcon ImageResize( int width, int height,ImageIcon img) { //이미지 크기 조정
