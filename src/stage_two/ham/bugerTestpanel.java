...
//	
	...
	int delidx=0;
	public static KeyListener klisten1 = null;
	bugerTestpanel(JFrame frame) {
		setLayout(null);
		panel = this;

		JLabel info = new JLabel("*1p는 A,W,S,D키를 사용합니다.");
		info.setFont(new Font("Binggrae",Font.BOLD, 20));
		info.setBounds(190, 10, 500, 30);
		info.setForeground(new Color(97,12,177));
		panel.add(info);
